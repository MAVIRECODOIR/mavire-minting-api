...
export declare class PlatformFeeInit__factory extends ContractFactory {
    ...
    static readonly bytecode = "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea264697066735822122046c9577aedeece6be8cc7847126896a61f0e6cf89fee44842bec6b87fda62d6264736f6c63430008170033";
    static readonly abi: {
        type: string;
        name: string;
        inputs: {
