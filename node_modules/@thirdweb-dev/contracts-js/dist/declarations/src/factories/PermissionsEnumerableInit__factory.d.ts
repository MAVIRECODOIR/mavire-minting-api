...
export declare class PermissionsEnumerableInit__factory extends ContractFactory {
    ...
    static readonly bytecode = "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea2646970667358221220b3b1b76e81414a080213914f9d62c9de6de3eaf915d69885b3ab6ee0c275b3ff64736f6c63430008170033";
    static readonly abi: {
        type: string;
        name: string;
        inputs: {
