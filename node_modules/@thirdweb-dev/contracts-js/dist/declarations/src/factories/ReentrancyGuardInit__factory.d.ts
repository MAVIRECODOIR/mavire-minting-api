...
import type { ReentrancyGuardInit, ReentrancyGuardInitInterface } from "../ReentrancyGuardInit";
...
export declare class ReentrancyGuardInit__factory extends ContractFactory {
    ...
    static readonly bytecode = "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea2646970667358221220f3feda91eef450cc2f15df5cfaf1943bd60c507729398f21303f615364873c7064736f6c63430008170033";
    static readonly abi: {
        type: string;
        name: string;
        inputs: {
