...
export declare class OwnableInit__factory extends ContractFactory {
    ...
    static readonly bytecode = "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea2646970667358221220599dac76a1ec2ddbf9350dbcef0e0d36a754cac9f1f5f14baf67d57153bcfdc864736f6c63430008170033";
    static readonly abi: {
        type: string;
        name: string;
        inputs: {
