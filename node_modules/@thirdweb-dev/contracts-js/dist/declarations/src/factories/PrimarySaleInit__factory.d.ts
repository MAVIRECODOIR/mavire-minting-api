...
export declare class PrimarySaleInit__factory extends ContractFactory {
    ...
    static readonly bytecode = "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea264697066735822122032ae39f0dedb7330e14fdc701c994ea08718336a424b9d8b9bf015a9b1089b5e64736f6c63430008170033";
    static readonly abi: {
        type: string;
        name: string;
        inputs: {
