import { a_ as getChainProvider, aI as fetchPublishedContractFromPolygon, aH as THIRDWEB_DEPLOYER$1, aJ as fetchAndCacheDeployMetadata, ax as getCreate2FactoryAddress, aF as encodeConstructorParamsForImplementation, aE as computeDeploymentInfo, av as isContractDeployed, a6 as resolveImplementation, K as fetchContractMetadataFromAddress, ao as fetchSourceFilesFromMetadata, a1 as extractConstructorParamsFromAbi, a4 as resolveContractUriFromAddress, aQ as getContractPublisherAddress, aa as fetchExtendedReleaseMetadata, cq as RPCConnectionHandler, aL as resolveAddress, aM as signTypedDataInternal, aS as ChainId, cr as ContractWrapper, aV as NATIVE_TOKEN_ADDRESS, cs as extractFeatures, ab as detectFeatures, aR as getMultichainRegistryAddress, bj as AbiSchema, ar as COMMON_FACTORY, aw as isEIP155Enforced, ct as CUSTOM_GAS_FOR_CHAIN, aG as getCreate2FactoryDeploymentInfo, aO as CONTRACT_ADDRESSES, cu as AddressZero, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, aC as computeForwarderAddress, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bG as CommonPlatformFeeSchema, bF as CommonPrimarySaleSchema, bH as CommonTrustedForwarderSchema, bC as CommonContractSchema, bE as CommonRoyaltySchema, bI as CommonSymbolSchema, aA as computeDeploymentAddress, az as getInitBytecodeWithSalt, aT as setSupportedChains, j as getContractTypeForRemoteName, b3 as getSignerAndProvider, ak as getCompositeABI, b1 as isChainConfig, aP as getContractAddressByChainId, cv as getProcessEnv, bS as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, aZ as EventType } from './index-ec6b8f75.browser.esm.js';
import { isBrowser, ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-47396b2c.browser.esm.js';
...
import { g as getDefaultGasOverrides, f as buildTransactionFunction, T as Transaction, h as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-31bf3ef7.browser.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-e741646c.browser.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-050f8e24.browser.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployContractDeterministic-b772b800.browser.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-df681a3c.browser.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
