...
import { bQ as SnapshotInputSchema, bR as SnapshotEntryWithProofSchema, bS as SnapshotSchema, cw as ContractWrapper, ba as BigNumberSchema, a_ as NATIVE_TOKEN_ADDRESS, cB as AmountSchema, cF as QuantitySchema, bb as BigNumberishSchema, cG as BytesLikeSchema, s as DuplicateLeafsError, be as AddressOrEnsSchema, bd as AddressSchema, cH as BasisPointsSchema } from './index-026909c5.esm.js';
import { f as fetchCurrencyMetadata, i as isNativeToken, a as fetchCurrencyValue } from './fetchCurrencyValue-4d23633a.esm.js';
import { n as normalizePriceValue } from './normalizePriceValue-c5ebbabe.esm.js';
import { MerkleTree } from '@thirdweb-dev/merkletree';
import { S as StartDateSchema, E as EndDateSchema } from './assertEnabled-ccd6fda8.esm.js';
import { z } from 'zod';
import { N as NFTInputOrUriSchema } from './setErc20Allowance-60f2ce3e.esm.js';
import { v4 } from 'uuid';
